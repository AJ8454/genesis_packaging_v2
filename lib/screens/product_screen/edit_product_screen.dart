    ...
    if (_isInit) {
      ...
      if (productId != null) {
        ...
        _initValues = {
          ...
          'alertQty': _editProduct.alertQty.toString(),
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                                      ...
                                      TextFormField(
                                        ...
                                        onSaved: (value) {
                                          _editProduct = Product(
                                            ...
                                            supplier: _editProduct.supplier,
                                            alertQty: _editProduct.alertQty,
                                            type: _editProduct.type,
                                          );
                                        },
                                        validator: (value) {
                              ...
                              TextFormField(
                                initialValue: _initValues['alertQty'],
                                decoration: const InputDecoration(
                                    labelText: 'Qty for Alert'),
                                onSaved: (value) {
                                  _editProduct = Product(
                                    title: _editProduct.title,
                                    id: _editProduct.id,
                                    ...
                                    size: _editProduct.size,
                                    supplier: _editProduct.supplier,
                                    alertQty: int.parse(value!),
                                    type: _editProduct.type,
                                  );
                                },
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    return 'Please enter Alert Qty.';
                                  }
                                  return null;
                                },
                              ),
